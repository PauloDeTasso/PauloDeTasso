...
[![Typing SVG](https://readme-typing-svg.demolab.com/?color=ffffff&size=35&center=true&vCenter=true&width=1000&lines=Ol%C3%A1%2C+Eu+Sou+Paulo+de+Tasso;Engenheiro+de+Software+em+forma%C3%A7%C3%A3o+-+7/8;+DevSecOps+FullStack;Seja+Bem-vindo%21%F0%9F%8E%89)](https://github.com/PauloDeTasso)
...
| ----------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------- |
| Engenharia de IA <br> LLM Engineering <br> Prompt Engineering <br> Context Engineering <br> Structured Output <br> Function Calling | Agentic AI <br> Agentes especializados <br> Subagentes <br> Sistemas multiagentes <br> Planejamento <br> Decomposição de tarefas <br> Delegação <br> Roteamento | Tool Calling <br> MCP <br> Function Calling <br> Ferramentas externas <br> APIs <br> Integração de ferramentas <br> Human-in-the-Loop |

| 🧩 RAG & Conhecimento                                                                                                                          | 🖥️ IA Local & Modelos                                                                                                                                                            | 🧪 Avaliação & Observabilidade                                                                                                                                         |
| ---------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| RAG <br> Embeddings <br> Vector Search <br> Semantic Search <br> Recuperação de conhecimento <br> Bases de conhecimento <br> Context Retrieval | LLMs locais <br> Modelos especializados em código <br> Modelos quantizados <br> Inferência local <br> Context Window <br> Parâmetros de inferência <br> Execução local de modelos | LLM Evaluation <br> Agent Evaluation <br> Testes de prompts <br> Testes de regressão <br> Golden Datasets <br> Avaliação de respostas <br> Traces <br> Observabilidade |

| 🔐 Segurança de IA                                                                                                                                                    | ⚙️ Automação & Desenvolvimento                                                                                                                                                                             | 🧑‍💻 Desenvolvimento Assistido                                                                                                                                                                                                       |
| --------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Prompt Injection <br> Jailbreak Defense <br> Data Leakage <br> Output Validation <br> Agent Security <br> Excessive Agency <br> Least Privilege <br> Tool Permissions | Automação de tarefas <br> Workflows inteligentes <br> Orquestração de processos <br> Delegação automática <br> Execução de ferramentas <br> Automação de desenvolvimento <br> Automação baseada em agentes | AI Coding <br> Agentic Coding <br> Desenvolvimento assistido por IA <br> Agentes especializados em desenvolvimento <br> Subagentes de desenvolvimento <br> Análise de código com IA <br> Geração de código <br> Refatoração assistida |
